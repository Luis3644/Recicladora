...
class _MisReportesOperadorState extends State<MisReportesOperador>
  ...
  Widget _buildLista() {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snap) {
        ...
        if (docs.isEmpty) {
          return _estadoVacio(
            icon: Icons.inbox_rounded, color: _slate,
            titulo: 'Sin reportes',
  ...
  Widget _estadoVacio({required IconData icon, required Color color,
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('DESCRIPCIÓN DEL INCIDENTE',
                    style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800,
                        color: _slate, letterSpacing: 0.8)),
              ),
              ...
              if (fotos.isNotEmpty) ...[
                ...
                Padding(
                  padding: const EdgeInsets.fromLTRB(16, 0, 16, 0),
                  child: Text('EVIDENCIA FOTOGRÁFICA',
                      style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800,
                          color: _slate, letterSpacing: 0.8)),
                ),
                const SizedBox(height: 10),
